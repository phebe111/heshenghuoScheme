//  状态：安装、安装中、打开、更新。 下载时会触发getAppState,安装显示时也会触发getAppState
import $ from 'jquery'
    ...
    function(e, t, n){
        var a = n(7), o = a.cmd, i = {
            download: function(e, t){
                var n = t.packagename, i = t.contentId, r = t.price || 0, s = t.size || 0, c = t.canOrder || !0,
                        p = t.url,
    ...
    function(e, t, n){
        var a = n(7), o = "init", i = "download", r = "pause", s = "downloaded", c = "install", p = "installed",
                l = "installing", u = "update", d = "error", A = "resume", f = "open", _ = "waitwifi", T = {
                    ...
                    OPEN: f,
                    WIFI: _
                }, g = 0, h = 1, m = 2, S = 3, v = 4, E = 5, w = 6, b = 7, C = 8, L = 9, M = 10, P = 11, D = 12, y = 255,
                O = -1,
